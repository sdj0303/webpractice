...
if (!$mb['mb_id'] || !($password === $mb['mb_password'])){ // mb_id를 배열로 접근하도록 수정
...
/*if ($mb['mb_email_certify'] == '0000-00-00 00:00:00') {
    ...
    $certify_href = 'http://localhost/email_certify.php?amp;mb_id='.$mb_id.'amp;mb_md5='.$mb_md5; // amp; 제거
    ...
    $mail_from = "tjehdwnaos77@naver.com";
    $mail_to = $mb['mb_email'];
